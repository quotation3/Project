...
class InstaProfileSpider(scrapy.Spider):
    ...
    # headers = {'user-agent' : 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/85.0.4183.83 Safari/537.36'}
    # cookies = {'ig_did' : '218F3791-047E-4C7B-9262-BB768399D41B',
    # 'mid' : 'X1czugALAAF9usOVmHKHfBl9vzrk',
    # 'shbid' : '8668\0546769785738\0541631102459:01f70f1371d3b7c85a508f5200040af472e08f84fa2975ed92647e5a9b6e337227a919d3',
    # 'shbts' : '1599566459\0546769785738\0541631102459:01f71c42053796939f2aaaa7dae314156c461e5a5971870e3976655cb393646323a2bf9d',
    # 'csrftoken' : 'jInbP6FsbQAGZ3eDBMa50Keltow5yWOo',
    # 'ds_user_id' : '41192186578',
    # 'sessionid' : '41192186578%3A7GGxgtQL7YM5dZ%3A25',
    # 'rur' : 'PRN\05441192186578\0541631259382:01f72a79bbf8db8c038a0f30406ca3b67c4fb6a9a09cb49474d99ad5da0c76fa2bcd085e',
    # 'urlgen' : '{\"223.62.188.96\": 9644}:1kGH82:pjr2dkjQcdahQ5UV-u0EemU4lyU'}
